...
# OpneCPN erstellte KML-Wegpunktdatei in das VSF Format.             #
# Den Inhalt der erstellten Textdatei komplett in die                #
# VSF Situationsdatei kopieren.                                      #
#                                                                    #
# Version:0.8          Datum:01.11.2021          Autor: Stefan Rothe #
#                                                                    #
# Release History:                                                   #
#                                                                    #
...
# Version 0.7: Intern, VS:NG Unterstuetzung und Menuleiste           #
# Version 0.8: Release, VS:NG Unterstuetzung und Menuleiste          #
#                                                                    #
######################################################################
...
class VSFRoute():
	...
	def __init__(self, master):
		...
		topframe=Frame(master, height=100, width=200, pady=10)
		topframe.pack(fill=NONE)
		self.editor=Text(topframe,height=30, width=80, padx=10, pady=5)
		...
		openButton = Button(bottomframe, padx = 10, pady=5, font=self.Helv10Bold, text="Open KML File...", command=self.konvertieren)
		...
		openButton.pack(side=LEFT)
		space=Label(bottomframe, padx = 10, pady=5, text='')
